...
- [2. - Объекты, переменные](#2---объекты-переменные)
- [3. - Функции, аргументы функции](#3---функции-аргументы-функции)
- [4. - Базовые структуры данных: tuple, list, set, frozenset, dict](#4---базовые-структуры-данных-tuple-list-set-frozenset-dict)
- [5. - Строки: bytes, bytearray, str. Кодировки](#5---строки-bytes-bytearray-str-кодировки)
- [6. - Классы. Методы `__new__`, `__init__`. Переопределение арифметических операций над объектами](#6---классы-методы-__new__-__init__-переопределение-арифметических-операций-над-объектами)
- [7. - Итератор. Устройство цикла for](#7---итератор-устройство-цикла-for)
- [8. - Генераторы. Генераторные выражения](#8---генераторы-генераторные-выражения)
- [9. - Генераторные функции](#9---генераторные-функции)
- [10. - list, set, dict comprehensions](#10---list-set-dict-comprehensions)
- [11. - Функции как объекты. Декораторы](#11---функции-как-объекты-декораторы)
- [12. - Наследование в классах](#12---наследование-в-классах)
- [13. - Обработка исключений](#13---обработка-исключений)
- [14. - Создание собственных классов исключений. Иерархии исключений.](#14---создание-собственных-классов-исключений-иерархии-исключений)
- [15. - Устройство with](#15---устройство-with)
- [16. - Модули, пакеты, import и его варианты](#16---модули-пакеты-import-и-его-варианты)
- [17. - Пространство имен, область видимости](#17---пространство-имен-область-видимости)
- [18. - Метод `__del__`. Удаление объектов при помощи подсчета ссылок](#18---метод-__del__-удаление-объектов-при-помощи-подсчета-ссылок)
- [19. - Работа с файлами](#19---работа-с-файлами)
- [20. - Создание потоков, модуль threading](#20---создание-потоков-модуль-threading)
- [21. - Способы создания процессов](#21---способы-создания-процессов)
...
# 4. - Базовые структуры данных: tuple, list, set, frozenset, dict
...
## 4.2. Tuple (iterable, immutable, hashable)
...
## 4.3. Dict (iterable(ключи), mutable)
Способы задачи:
```python
d1 = {}
...
## 4.5. Frozenset (iterable, immutable)
...
# 5. - Строки: bytes, bytearray, str. Кодировки
`bytes.encode() -> str`

`str.decode() -> bytes`


## 5.1. Str (iterable, immutable, hashable)
...
## 5.2. Bytes (iterable, immutable, hashable)
...
## 5.3. Bytearray (iterable, mutable)
...
# 6. - Классы. Методы `__new__`, `__init__`. Переопределение арифметических операций над объектами
...
# 7. - Итератор. Устройство цикла for
...
```
# 8. - Генераторы. Генераторные выражения
...
## 8.1. Средства для создания генераторов
### 8.1.1. Генераторные функции
```python
...
# 11. - Функции как объекты. Декораторы
...
# 14. - Создание собственных классов исключений. Иерархии исключений.
...

# 16. - Модули, пакеты, import и его варианты
...
# 17. - Пространство имен, область видимости
...

# 18. - Метод `__del__`. Удаление объектов при помощи подсчета ссылок
...

# 20. - Создание потоков, модуль threading
